<?php
	...
	$servername = "localhost";
  	...
  	$sql0 = "SELECT * FROM faculty WHERE Username = '" . $user . "'";
...
<body>
	<div class="row">
		...
		<div class="details">
			<b>Designation:</b> <?php echo $row0["Designation"] ?><br>
			<b>Department:</b> <?php echo $row0["Department"] ?><br>
		</div>
	</div><br>
	<div id="resp" style="display: none">
		<button class="button" name="approve" value="approve">Approve</button><br>
		<button class="button" name="reject" value="reject">Deny</button>
	</div>
	<div class="status">
		<table>
			<tr>
				...
				if ($result1 != FALSE) {
					...
					while ( $row1 = $result1 -> fetch_assoc()) {
						...
						if ($row1['Status'] == 'Waiting') {
							...
							echo "<form method = 'POST' action = 'responsef.php'>";
